...
begin
    ...
    if exists(select * from recipe r where r.RecipeId = @RecipeId and ((r.RecipeStatus = 'Archived' and datediff(day, r.DateArchived, getdate() ) < 30) or r.RecipeStatus = 'Published'))
    begin
